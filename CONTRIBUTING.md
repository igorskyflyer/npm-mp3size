# 🫱🏼‍🫲🏼 Contributing to Mp3 Size

Thank you for considering a contribution to Mp3 Size! Whether you're fixing bugs, suggesting improvements, writing docs, or sharing ideas – your input helps the project grow and evolve.
...
- If you're unsure, feel free to open an [`issue`](https://github.com/igorskyflyer/npm-mp3size/issues) or discussion to explore the idea.
...
Your contribution helps maintain and improve Mp3 Size — thank you for helping make it better!  
Check out [`SUPPORT.md`](https://github.com/igorskyflyer/npm-mp3size/blob/main/SUPPORT.md) if you need help or want to sponsor its development.
